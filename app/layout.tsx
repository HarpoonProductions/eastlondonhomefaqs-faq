...
// Search Component with blue theme for East London
    ...
    <div className="relative max-w-2xl mx-auto">
      ...
      <div className="relative">
        ...
        <input
          ...
          placeholder="Search East London housing questions..."
        />
        {query && (
          <button
            onClick={() => {
          ...
          {searchResults.length > 0 ? (
            ...
            <div className="px-4 py-8 text-center">
              ...
              <p className="text-sm text-slate-600 mb-4">
                We couldn&apos;t find any East London property FAQs matching &quot;{query}&quot;
              </p>
              <button
                onClick={() => {
                  setIsOpen(false);
        ...
        <div className="pt-16 pb-12 px-4 sm:px-6 lg:px-8">
          <div className="mx-auto text-center" style={{ maxWidth: '1600px' }}>
            <Link href="/" className="inline-block">
              <h1 className="text-5xl font-bold text-[#071939] mb-2">
